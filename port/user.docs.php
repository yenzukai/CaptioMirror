...
<body onclick="closeSidebar(event)">
    ...
    <div class="container mt-5">
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <!-- Burger Menu Icon -->
            <img src="../assets/svg/light-burger-menu-svgrepo-com.svg" class="burger-menu" alt="A Burger Menu" onclick="toggleSidebar(event)">
    ...
    <div class="d-flex">
        ...
        <div class="container my-5 ms-4">
            <!-- Getting Started Section -->
            <section id="getting-started">
                <h2 class="text-secondary">1. Getting Started</h2>
                <div class="section-content">
                    <h3 id="introduction">1.1 Introduction</h3>
                    <p>
                    The CaptioMirror is an IoT-based smart mirror platform designed to be used into every daily routines of users, transforming our household mirrors into interactive personal assistants. 
                    ...
                    <p>Recommended: Raspbian OS (Latest Version)</p>

                    <h4>1.2.3 NodeJS</h4>
                    <p>NodeJS version v22.11.0 or later is required. Install NodeJS using the terminal:</p>
                    <pre><code>sudo apt install nodejs</code></pre>

                    <h3 id="installation">1.3 Installation (Raspbian OS)</h3>

                    <p>1. Download and install the required version of <strong>Node.js</strong>:</p>
                    <pre><code>sudo apt install nodejs</code></pre>

                    <p>2. Ensure that both <strong>Apache2</strong> and <strong>MariaDB</strong> are installed:</p>
                    <pre><code>sudo apt install apache2 mariadb-server</code></pre>

                    <p>3. Check if <strong>Git</strong> is installed by executing <code>git --version</code>. If it’s not installed, install it with:</p>
                    ...
                    <p>6. Make sure the Apache2 service is running. Start it if it's not:</p>
                    <pre><code>sudo systemctl start apache2</code></pre>

                    <p>7. Configure MariaDB with the following credentials:</p>
                    <ul>
                    ...
                    <p>8. Log into the MariaDB console:</p>
                    <pre><code>sudo mysql -u root -p</code></pre>

                    <p>9. Create a database named <code>CaptioMirror</code>:</p>
                    <pre><code>CREATE DATABASE CaptioMirror;</code></pre>

                    <p>10. Import the <code>captiomirror.sql</code> file into MariaDB:</p>
                    ...
                    <p>11. Download and install <strong>ngrok</strong> from <a href="https://ngrok.com/download">ngrok.com/download</a>. Follow the instructions on the website for your OS.</p>

                    <p>12. Start ngrok to expose the Apache server to the internet:</p>
            ...
            <!-- Modules Section -->
            <section id="modules">
                <h2 class="text-secondary">2. Modules</h2>
                <div class="section-content">
                    ...
                    <h4>2.2.1 Dashboard Configuration (index.php)</h4>
                    ...
                    <h4>2.2.3 JavaScript Configuration</h4>
            ...
            <!-- Voice Commands -->
            <section id="commands">
                <h2 class="text-secondary">3. Voice Commands</h2>
                <div class="section-content">
            ...
            <!-- About Section -->
            <section id="about">
                <h2 class="text-secondary">4. About</h2>
                <div class="section-content">
                    ...
                    <p>For support, please contact: <a href="mailto:mjrojasforex@gmail.com">mjrojasforex@gmail.com</a></p>
